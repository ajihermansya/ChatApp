package com.rumahcerita.chappappclonewa.adapter
...
import com.rumahcerita.chappappclonewa.databinding.ReceiverLayoutItemBinding
import com.rumahcerita.chappappclonewa.databinding.SentItemLayoutBinding
import com.rumahcerita.chappappclonewa.model.MessageModel
...
class MessageAdapter(var context : Context, var list: ArrayList<MessageModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (holder.itemViewType == ITEM_SENT) {
            ...
            viewHolder.binding.userRcv.text = message.message
        }
    }
